		 ...
		 <div id="accordion">
		  <div class="card">
			...
			<div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
			  <div class="card-body">
				Café da tarde com os condônimos.
				<hr>
                <b>Data de agendamento</b> : 18/10/2018 15:00<br>
		  ...
		  <div class="card">
			<div class="card-header" id="headingThree">
			  <h5 class="mb-0">
				<button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
				  Votacao numero de vagas - Tipo : Votação
				</button>
			...
			<div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
			  <div class="card-body">
				O que vocês acham de aumentar o número de vagas de garagem para 4 para cada morador e retirar as motos?
				<hr>
				<b>Data de inicio</b> : 20/06/2018<br>
				<b>Data de término</b> : 29/06/2018<br>
				<b>Status</b> : Finalizado<br>
				<b>Resultado votação</b> : Contra<br>
				<hr>
				<div class="row">
					<div class="col-md-4">
						<button type="button" disabled class="btn btn-primary btn-lg">Sou a favor</button>
						<button type="button" disabled class="btn btn-secondary btn-lg">Sou contra</button>
					</div>
					<div class="col-md-8">
						<div class="progress" style="margin:20px;">
							...
							<div class="progress-bar progress-bar-warning" role="progressbar" style="width:70%">
								Votos contra
							</div>
						</div>
					</div>
			...
			<div class="card-header" id="headingTwo">
			  <h5 class="mb-0">
				<button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
				  Animais - Tipo : Enquete
				</button>
				<h6 style="margin-left:14px;;">Criador : Luana Duarte</h6>
			  </h5>
			</div>
			<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
			  <div class="card-body">
				Enquete a respeito de animais no condomínio
				<hr>
				 <div class="form-group">
