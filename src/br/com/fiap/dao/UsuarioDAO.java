...
private  ResultSet rs;
      ...
      public String criarUsuario(Usuario user)throws Exception{
    	  stmt= con.prepareStatement
    			  ("INSERT INTO T_DBC_USUARIO (id_usuario, "
    			  		+ "ds_senha,"
    			  		+ "ds_tipo,"
    			  		+ "ds_nome,"
    			  		+ "nr_cpf,"
    			  		+ "dt_nascimento,"
    			  		+ "ds_email,nr_fone,id_endereco) VALUES(?,?,?,?,?,?,?,?,?)");
      ...
      public Usuario consultarPorId(int numero)throws Exception{
    	  stmt = con.prepareStatement
    			  ("SELECT * FROM T_DBC_USUARIO  INNER JOIN T_DBC_ENDERECO ON "
    			  		+ "(T_DBC_ENDERECO.id_endereco =T_DBC_USUARIO.ID_ENDERECO)"
    			  		+ " WHERE ID_USUARIO = ?");
