    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light" style="margin-top:-50px;">
	  ...
	  <div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav ml-auto pull-right">
		  ...
		  <li class="nav-item">
			<a class="nav-link" href="registrar.html">Registre-se</a>
		  </li>
		</ul>
		...
		<br>
         ...
         <form class="needs-validation" novalidate>
            ...
            <div class="form-row">
               ...
               <div class="col-md-4 mb-3">
                  <label for="idFone">Fone</label>
                  <input type="tel" class="form-control" id="idFone" placeholder="Fone" required>
               </div>
            </div>
            <div class="row">
               <div class="col-md-12">
            ...
            <a href="home.html" class="btn btn-primary">Voltar</a>
         </form>
      </div>
      <script>
         (function() {
